...
public extension MainFactory {
    static func createMain<StateType, H0: IOHandling, H1: IOHandling, H2: IOHandling, H3: IOHandling, H4: IOHandling, H5: IOHandling, H6: IOHandling, H7: IOHandling>(topLevelFunction: @escaping (StateType, IOContainer8<H0.IO, H1.IO, H2.IO, H3.IO, H4.IO, H5.IO, H6.IO, H7.IO>) -> (StateType, IOContainer8<H0.IO, H1.IO, H2.IO, H3.IO, H4.IO, H5.IO, H6.IO, H7.IO>),
                                                                                                                                                                      initialState: StateType,
                                                                                                                                                                      handlerTypes: (H0.Type, H1.Type, H2.Type, H3.Type, H4.Type, H5.Type, H6.Type, H7.Type)) -> Main {
        typealias IO = IOContainer8<H0.IO, H1.IO, H2.IO, H3.IO, H4.IO, H5.IO, H6.IO, H7.IO>
        let handlers = (H0(), H1(), H2(), H3(), H4(), H5(), H6(), H7())
...
public struct IOContainer8<T0: IOType, T1: IOType, T2: IOType, T3: IOType, T4: IOType, T5: IOType, T6: IOType, T7: IOType>: IOContaining {
