...
public extension MainFactory {
    static func createMain<StateType, H0: IOHandling, H1: IOHandling, H2: IOHandling, H3: IOHandling, H4: IOHandling, H5: IOHandling, H6: IOHandling, H7: IOHandling, H8: IOHandling, H9: IOHandling>(topLevelFunction: @escaping (StateType, IOContainer10<H0.IO, H1.IO, H2.IO, H3.IO, H4.IO, H5.IO, H6.IO, H7.IO, H8.IO, H9.IO>) -> (StateType, IOContainer10<H0.IO, H1.IO, H2.IO, H3.IO, H4.IO, H5.IO, H6.IO, H7.IO, H8.IO, H9.IO>)?,
        ...
        let handlers = (H0(), H1(), H2(), H3(), H4(), H5(), H6(), H7(), H8(), H9())
        ...
        return .init(mainHelper: MainHelper(topLevelFunction: topLevelFunction,
                                            ...
                                            initialIO: .init()) { outputs, inp in
                                                ...
                                                MainHelper<StateType, IO>.process(outputs: outputs.outputs9, handler: handlers.9) { inp(.create($0), $1) }
        })
    }
}


public struct IOContainer10<T0: IOType, T1: IOType, T2: IOType, T3: IOType, T4: IOType, T5: IOType, T6: IOType, T7: IOType, T8: IOType, T9: IOType>: IOContaining {
    ...
    public func input(forToken token: IOToken<T9>) -> T9.Input? {
        core.input(inputStorage: core.inputs.input9, token: token)
    }
    ...
    public func addingOutput(_ output: T9.Output) -> (io: Self, token: IOToken<T9>) {
        core.updatingOutputs({ $0.copy(override9: $0.outputs9.adding((output, $1))) }) { .init(core: $0) }
    }
    ...
    struct Inputs {
        ...
        static func create(_ input: T9.Input?) -> Self {
            .init(input9: input)
        }
        ...
        fileprivate let input9: T9.Input?
