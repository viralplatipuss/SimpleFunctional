...
public final class ImpureApp<AppType: PureAppProviding, IOHandlerType: IOHandling> where AppType.IOType == IOHandlerType.IOType {
    ...
    private func run(input: AppType.IOType.Input?) {
    ...
    private func processOutputs(_ outputs: [AppType.IOType.Output]) {
    ...
    private func processOutput(_ output: AppType.IOType.Output) {
        ioQueue.async { [weak self] in
